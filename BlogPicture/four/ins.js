    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://raw.githubusercontent.com/prestu/prestu.github.io/master/BlogPicture/min_photos/' + data.link[i] + '.min.jpg';
          var src = 'https://raw.githubusercontent.com/prestu/prestu.github.io/master/BlogPicture/photos/' + data.link[i];
          ...
          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">\
                <a href="' + src + '" itemprop="contentUrl" data-size="640x640" data-type="' + type + '" data-target="' + target + '">\
                  <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="/BlogPicture/four/ins/img/empty.png" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
